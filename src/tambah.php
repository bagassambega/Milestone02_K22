        ...
        <div class="tambah-container">
            ...
            <form action="add-item.inc.php" method="post">
                <div class="tambah-form">
                    ...
                    <input autocomplete="off" type="text" placeholder="Warung Asiapp.." name="namaTempat">
                </div>
                <div class="tambah-form">
                    <label for="alamat"><h4>Alamat</h4></label>
                    <input autocomplete="off" type="text" placeholder="Sebelah ATM, Jalan Ganesha no 1" name="alamat">
                </div>
                <div class="tambah-form">
                    <label for="Kategori"><h4>Kategori</h4></label>
                    <input autocomplete="off" type="text" placeholder="Cafe/Rumah makan/Warung..." name="category">
                </div>
                <div class="tambah-form">
                    <label for="jam_buka"><h4>Jam Buka</h4></label>
                    <input type="text" autocomplete="off" placeholder="Jam Buka" name="jamBuka">
                </div>
                <div class="tambah-form">
                    <label for="linkmenu"><h4>Link Menu/Range Harga Menu</h4></label>
                    <input autocomplete="off" type="text" placeholder="menu.com...." name="menu">
                </div>
                <div class="tambah-form">
                    <label for="sosmed"><h4>Sosial Media</h4></label>
                    <input autocomplete="off" type="text" placeholder="@gubernur, @warga" name="socmed">
                </div>
                <div class="tambah-form">
                    <label for="linkgambar"><h4>Link Gambar</h4></label>
                    <input autocomplete="off" type="text" placeholder="photos.com..." name="gambar">
                </div>
                <div class="tambah-form">
                    <label for="linkmaps"><h4>Link Google Maps</h4></label>
                    <input autocomplete="off" type="text" placeholder="maps.google.com/..." name="linkMaps">
                </div>
                <div class="tambah-form">
                    <label for="deskripsi"><h4>Jelasin dong!</h4></label>
                    <textarea autocomplete="off" name="deskripsi" type="text" rows="5" cols="50" placeholder="MURAH BANGET, pedesnya mantappp ..."></textarea>
                </div>
                <div class="tambah-form">
                ...
                <div class="tambah-form">
                    <label for="komentar"><h4>Komentarin dong!</h4></label>
                    <textarea autocomplete="off" name="komen" type="text" rows="5" cols="50" placeholder="MURAH BANGET, pedesnya mantappp ..."></textarea>
                </div>
                <div class="tambah-form">
